...
public class ApptTest
{
  ...
  {
    Appt myappt = new Appt(14, 30, 25, 11, 2019, "Discord Meetup", "IRL meetup for Discord Server", "real-email@real-email-website.com");
    myappt.setValid();
  ...
  {
    Appt myappt = new Appt(14, 30, 32, 2, 2019, "Discord Meetup", "IRL meetup for Discord Server", "real-email@real-email-website.com");
    myappt.setValid();
    assertFalse(myappt.getValid());
  }
  ...
  {
    Appt myappt = new Appt(14, 30, 32, 2, 2016, "Discord Meetup", "IRL meetup for Discord Server", "real-email@real-email-website.com");
    myappt.setValid();
    assertFalse(myappt.getValid());
  }
